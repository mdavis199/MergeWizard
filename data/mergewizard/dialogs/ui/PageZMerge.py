...
class Ui_PageZMerge(object):
    def setupUi(self, PageZMerge):
        ...
        self.zMergeView.header().setMinimumSectionSize(50)
        ...
        self.originalZMerge = QtWidgets.QTreeView(self.originalBox)
        self.originalZMerge.setObjectName("originalZMerge")
        self.verticalLayout_4.addWidget(self.originalZMerge)
