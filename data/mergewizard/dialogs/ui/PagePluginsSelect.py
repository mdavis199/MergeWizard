...
class Ui_PagePluginsSelect(object):
    def setupUi(self, PagePluginsSelect):
        ...
        self.widget = QtWidgets.QWidget(self.allPluginsSplitter)
        self.widget.setObjectName("widget")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.widget)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.pluginsList = PluginView(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout_2.addWidget(self.pluginsList)
        self.pluginFilterWidget = PluginFilterBox(self.widget)
        self.pluginFilterWidget.setObjectName("pluginFilterWidget")
        self.verticalLayout_2.addWidget(self.pluginFilterWidget)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.toggleFilterButton = QtWidgets.QToolButton(self.widget)
        self.toggleFilterButton.setCheckable(True)
        self.toggleFilterButton.setObjectName("toggleFilterButton")
        self.horizontalLayout.addWidget(self.toggleFilterButton)
        ...
        self.filterCount = QtWidgets.QLabel(self.widget)
        self.filterCount.setObjectName("filterCount")
        self.horizontalLayout.addWidget(self.filterCount)
