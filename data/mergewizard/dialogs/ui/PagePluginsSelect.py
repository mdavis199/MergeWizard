...
class Ui_PagePluginsSelect(object):
    def setupUi(self, PagePluginsSelect):
        ...
        self.verticalLayout_1 = QtWidgets.QVBoxLayout(self.pluginGroup)
        ...
        self.bulkAddWidget = PluginTextWidget(self.selectedPluginsSplitter)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.bulkAddWidget.sizePolicy().hasHeightForWidth())
        self.bulkAddWidget.setSizePolicy(sizePolicy)
        ...
        self.verticalLayout.addWidget(self.toggleBulkButton)
    ...
    def retranslateUi(self, PagePluginsSelect):
        ...
        self.toggleBulkButton.setToolTip(_translate("PagePluginsSelect", "You may select plugins by typing or pasting names"))
